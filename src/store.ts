...
type EditorState = {
  ...
  project: Project; selected: string[]; playhead: number; seekRevision: number; playing: boolean; shuttleRate: number; zoom: number; snapping: boolean; tool: 'select' | 'razor' | 'rate';
...
export const useEditor = create<EditorState>((set, get) => ({
  ...
  project: emptyProject(), selected: [], playhead: 2.4, seekRevision: 0, playing: false, shuttleRate: 1, zoom: 48, snapping: true, tool: 'select', panel: 'media', inspectorTab: 'video',
