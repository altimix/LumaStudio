...
export default function DrawingPanel(){
  ...
  return <div className="drawing-panel library-browser"><fieldset className="library-section-scroll drawing-options" disabled={busy}>
    ...
    <label className="drawing-setting">表示時間 <span><input aria-label="表示時間（秒）" type="number" min={.1} max={60} step={.1} value={settings.duration} onChange={e=>{const n=Number(e.target.value);if(n>=.1&&n<=60)patch({duration:n});}}/>秒</span></label>
