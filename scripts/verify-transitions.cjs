...
async function verify(){
  ...
  }catch(error){await page.screenshot({path:path.join(results,'transitions-failure.png')}).catch(()=>{});throw error;}finally{await app.close();}
