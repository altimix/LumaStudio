...
export function effectRegionBounds(blur, width, height) {
  return {
...
export function gaussianBlurBounds(blur, width, height) { return { ...effectRegionBounds(blur,width,height), sigma: Math.max(.5, width * blur.sigma) }; }
...
export function ffmpegRegionBlend(b) {
...
export function ffmpegGaussianBlend(clip) { return ffmpegRegionBlend(clip.gaussianBlur); }
